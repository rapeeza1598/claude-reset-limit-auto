...
ARG TARGETARCH
# not covered by Dependabot (its docker ecosystem only tracks FROM lines) —
# auto-checked weekly and bumped via PR instead by
# .github/workflows/update-supercronic.yml.
